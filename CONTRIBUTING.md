...
Welcome to `gh-actions-tf` contributor's guide.
...
If you experience bugs or general issues with `gh-actions-tf`, please have a look
...
You can help improve `gh-actions-tf` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`gh-actions-tf` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `gh-actions-tf`'s files. While this mechanism can
...
```
conda create -n gh-actions-tf python=3 six virtualenv pytest pytest-cov
conda activate gh-actions-tf
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/gh-actions-tf.git
   cd gh-actions-tf
   ```
...
5. Install [pre-commit]:
   ...
   `gh-actions-tf` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/gh-actions-tf
[issue tracker]: https://github.com/<USERNAME>/gh-actions-tf/issues
